...
**一、站外AI引荐渠道的质量指标已经反转，但反转的因果性未被证明。** 美国零售网站AI来源流量的转化率在一年内由低于非AI渠道38%转为高于42%，单次访问收入高出37%（Adobe Digital Insights）。需同时指出：这是渠道间的观察性对比，而同期该渠道的累计流量指数由100升至493（增至约4.9倍），访客构成必然发生大幅迁移，反转中有多少来自渠道本身、多少来自构成变化，公开数据无法区分。增速方面已明确放缓——同比增速由2025年12月的+1151%回落至2026年3月的+269%。
...
**关于质量反转的因果性**：转化率由−38%转为+42%是过去一年最实质的变化，但它是渠道间的观察性对比。同期该渠道的累计流量指数由100升至493（增至约4.9倍）（下表），访客构成必然发生大幅迁移——早期AI购物用户与规模化后的用户在购买意向上并不相同。反转中来自渠道效率提升与来自访客构成变化的比例，公开数据无法区分。因此本报告的表述是「质量指标已反转」，而非「AI渠道更有效」。
...
**读法说明**：DAU与人均IPV的两组倍数（约0.09×与约9倍）方向相反、量级相近，因而**几近相互抵消**，其乘积为0.78×（即日均有效商品浏览量之比）。二者不是倒数关系——0.09的倒数为11.11。这意味着「淘宝侧DAU为千问侧的11.63倍而有效浏览量仅为1.28倍」与「人均IPV约差9倍」是同一事实的两种表述，前者只是把差距换到了业务可直接理解的尺度上，并未提供额外信息。
...
**第一，站外AI引荐的质量指标已反转，但因果性未被证明，且增速窗口正在关闭。** 转化率由−38%转为+42%是过去一年最实质的变化，但同期渠道流量增至约4.9倍（累计指数100→493），访客构成必然迁移，反转的归因无法从公开数据中分离。增速方面已由+1151%回落至+269%。合理的姿态是低成本占位与监测，而不是按外推规模做重投入。
...
若过程指标未达门槛，实验结果不得用于下述证伪判断。三项门槛（≥80%／≥80%／≥90%）与下文的证伪阈值+30%、护栏阈值+10%均为**设定值**，依据是「改造覆盖面须显著高于半数才能归因于形态」这一工程判断，无外部基准；上线后应按首轮实测结果回调。
...
| 判断 | 入口曝光已把DAU做到千问电商场景的11.63倍，但每轮对话产出仅为其约1/4；形态与「单轮问答后结束、未进入选品」一致。量化对照与可比性限制见§1.6，改造路径与证伪条件见§1.8建议一，此处不重复 | 本报告分析 |
...
| Shopify | Agentic Storefronts明确把结账留在商家店铺 | 协议设计 |
...
**该判断的证伪条件**：若在2027年底前出现一个M1类产品（AI平台作为Merchant of Record、跨主体代结账）在单一市场取得10%以上的头部商家接入率，则「交易结构决定成败」不成立，应转而检验「M1失败源于执行与时点而非结构」这一替代解释。观察指标为主要AI入口的代结账商家覆盖数——当前该数字为0（Instant Checkout已下线）。
...
| 图2 | AI引荐流量质量：转化率与单次访问收入 | Adobe Digital Insights（2026-04） | 渠道间观察性对比；同期渠道流量增至约4.9倍，访客构成迁移无法从公开数据中分离 | P1（实测） |
...
| 图9 | 站内AI导购与站外AI引荐效果对照 | 亚马逊2025Q4财报电话会（P2）、Adobe（P1）、Shopify（P2） | 面板①②按对照构造分列（使用者对未使用者／AI渠道对非AI渠道），面板②内含转化率与单次访问收入两类被测量、已在标签写明；面板③为同比增速，不是一种对照构造；面板①仅一根柱是本图的主要事实；Salesforce企业分组数据未纳入 | P1＋P2 |
...
| Adobe口径转化率反转（−38%→+42%） | 渠道间观察性对比；同期渠道流量增至约4.9倍，访客构成迁移无法分离 | 表述为「质量指标已反转」而非「AI渠道更有效」；摘要与§1.1、§1.8均标注因果性未证明 |
